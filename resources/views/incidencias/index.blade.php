...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-3">
        <a class="navbar-brand" href="#">App Incidencias</a>
        {{-- Podrías poner un botón de logout o menús adicionales aquí --}}
    </nav>
    ...
    <div class="d-flex justify-content-between align-items-center p-3 mb-2 bg-white shadow-sm rounded border card-hover">
        ...
        <div>
            <a href="{{ route('incidencias.show', $incidencia->id) }}" class="btn btn-outline-info btn-sm">
                Ver Detalle
            </a>
        </div>
    </div>
